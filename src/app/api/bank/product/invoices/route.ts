...
export async function POST(req: NextRequest) {
  ...
  // Validation removed: invoiceNumber is now generated by the backend
  if (!body.customerId) {
  ...
  const result = await createInvoiceDraft(session.user, {
    ...
    originalInvoiceId: body.originalInvoiceId || undefined,
    creditReason: body.creditReason || undefined,
  });
